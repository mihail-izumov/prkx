...
<br>
> В этом квартале осталось <Badge type="tip" text="**(2)** места" />
>**(7)** компаний уже в листе ожидания на следующий период. <br>
...
> **Не готовы?** <br>
> [Скачайте чек-лист готовности](/checkup/checklist) и вернитесь позже <br><br>
